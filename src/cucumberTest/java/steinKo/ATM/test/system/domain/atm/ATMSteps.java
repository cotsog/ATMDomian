package steinKo.ATM.test.system.domain.atm;
...
public class ATMSteps  implements En {
	...
	private int paKonto ;
	private static AnnotationConfigApplicationContext annotationConfigApplicationContext = new AnnotationConfigApplicationContext(Domain.class);
	...
	{ 
		...
		logger.info("Set up");
		annotationConfigApplicationContext = new AnnotationConfigApplicationContext(Domain.class);
